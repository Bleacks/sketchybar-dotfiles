...
# Notch Size
P_DYNAMIC_ISLAND_MAX_HEIGHT=150
P_DYNAMIC_ISLAND_DEFAULT_HEIGHT=90
P_DYNAMIC_ISLAND_DEFAULT_WIDTH=188
...
#
P_DYNAMIC_ISLAND_APPSWITCH_EXPAND_WIDTH=188 # This value should match the notch size, appearence wise
...
#
P_DYNAMIC_ISLAND_VOLUME_EXPAND_WIDTH=188 # This value should match the notch size, appearence wise
...
#
P_DYNAMIC_ISLAND_BRIGHTNESS_EXPAND_WIDTH=188 # This value should match the notch size, appearence wise
...
P_DYNAMIC_ISLAND_MUSIC_INFO_EXPAND_WIDTH=188 # This value should match the notch size, appearence wise
...
# Resume Info
P_DYNAMIC_ISLAND_MUSIC_RESUME_EXPAND_WIDTH=188 # This value should match the notch size, appearence wise
...
## WIFI Island config
#
P_DYNAMIC_ISLAND_WIFI_EXPAND_WIDTH=188 # This value should match the notch size, appearence wise
...
#
P_DYNAMIC_ISLAND_BATTERY_EXPAND_WIDTH=188 # This value should match the notch size, appearence wise
...
#
P_DYNAMIC_ISLAND_NOTIFICATION_EXPAND_WIDTH=188 # This value should match the notch size, appearence wise
...
# P_DYNAMIC_ISLAND_COLOR_BLACK=0xffffffff
